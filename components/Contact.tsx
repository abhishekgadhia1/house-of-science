      ...
      <div className="max-w-7xl mx-auto px-6 md:px-6 lg:px-12 flex-grow flex flex-col justify-center animate-fade-in">
        <div className="grid md:grid-cols-2 gap-8 md:gap-16">
          ...
          <div>
            ...
            <p className="text-slate-600 text-sm md:text-lg max-w-md mb-6 md:mb-12 font-normal leading-relaxed">
            ...
            <div className="space-y-4 md:space-y-6">
               <div className="group flex items-baseline justify-between border-b border-slate-200 py-4 md:py-6 cursor-pointer hover:border-indigo-600 transition-colors gap-4">
                  <span className="text-slate-500 group-hover:text-indigo-700 transition-colors font-medium shrink-0 text-sm">
                    <span className="md:hidden">Contact</span>
                    <span className="hidden md:inline">General Inquiries</span>
                  </span>
          ...
          <div className="bg-white p-4 md:p-8 border border-slate-100 rounded-xl shadow-lg shadow-indigo-100/50">
            <form className="space-y-4 md:space-y-6">
                <div>
                   <label className="block text-xs font-mono text-slate-500 uppercase tracking-widest mb-2 font-semibold">Name</label>
                   <input type="text" className="w-full bg-slate-50 border border-slate-200 py-2 px-3 md:p-4 text-xs md:text-base text-slate-900 focus:border-indigo-600 focus:ring-0 transition-colors outline-none rounded-md" placeholder="Full Name" />
                </div>
                <div>
                   <label className="block text-xs font-mono text-slate-500 uppercase tracking-widest mb-2 font-semibold">Email Address</label>
                   <input type="email" className="w-full bg-slate-50 border border-slate-200 py-2 px-3 md:p-4 text-xs md:text-base text-slate-900 focus:border-indigo-600 focus:ring-0 transition-colors outline-none rounded-md" placeholder="Email Address" />
                </div>
                <div>
                   <label className="block text-xs font-mono text-slate-500 uppercase tracking-widest mb-2 font-semibold">Message</label>
                   <textarea rows={4} className="w-full bg-slate-50 border border-slate-200 py-2 px-3 md:p-4 text-xs md:text-base text-slate-900 focus:border-indigo-600 focus:ring-0 transition-colors resize-none outline-none rounded-md" placeholder="Tell us about your requirements (Individual or School)..."></textarea>
                </div>
                <button className="w-full bg-indigo-600 text-white py-3 md:py-4 text-[10px] md:text-xs font-bold uppercase tracking-widest hover:bg-indigo-700 transition-all shadow-md rounded-md">
                   Send Message
                </button>
            </form>
          </div>
