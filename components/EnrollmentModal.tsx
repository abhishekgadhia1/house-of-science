            ...
            <>
              ...
              <div className="w-full md:w-1/2 flex-none p-3 md:p-12 border-b md:border-b-0 md:border-r border-slate-100 overflow-y-auto custom-scrollbar">
                ...
                <div className="space-y-3 md:space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-3 md:gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-100 md:border-slate-200 p-2 md:p-4 text-slate-900 font-mono md:font-sans text-[11px] md:text-sm focus:border-indigo-600 outline-none transition-all placeholder-slate-300"
                      />
                    </div>
                    <div>
                      <label className="block text-[9px] md:text-xs font-mono font-bold text-slate-400 md:text-slate-500 uppercase tracking-widest mb-1 md:mb-2">
                  ...
                  <div className="h-px bg-slate-200 md:bg-slate-100 my-3 md:my-8" />

                  {/* Subject and Grade in one line on mobile */}
                  <div className="grid grid-cols-2 gap-2 md:grid-cols-1 md:gap-0 md:space-y-6">
                    {/* Subject Dropdown */}
                    <div>
                      <label className="block text-[9px] md:text-xs font-mono font-bold text-slate-400 md:text-slate-500 uppercase tracking-widest mb-1 md:mb-2">
                        01. Select Subject
                      ...
                      <select
                        ...
                        className="w-full bg-slate-50 border border-slate-100 md:border-slate-200 p-2 md:p-4 text-slate-900 font-mono md:font-sans text-[11px] md:text-sm focus:border-indigo-600 outline-none transition-all appearance-none cursor-pointer"
                      >
                    ...
                    {/* Grade Dropdown */}
                    <div className={!selectedSubject ? 'md:opacity-50 pointer-events-none' : ''}>
                      <label className="block text-[9px] md:text-xs font-mono font-bold text-slate-400 md:text-slate-500 uppercase tracking-widest mb-1 md:mb-2">
                        02. Select Grade
                      </label>
                      <select
                  ...
                  {/* Topic Dropdown */}
                  <div className={!selectedGrade ? 'md:opacity-50 pointer-events-none' : ''}>
                    <label className="block text-[9px] md:text-xs font-mono font-bold text-slate-400 md:text-slate-500 uppercase tracking-widest mb-1 md:mb-2">
                      03. Select Topic
                    </label>
                    <select
                  ...
                  <button
                    ...
                    className="w-full bg-indigo-600 text-white font-mono md:font-sans font-bold uppercase tracking-[0.2em] md:tracking-widest py-2 md:py-4 text-[10px] md:text-xs hover:bg-indigo-700 transition-all disabled:opacity-50 flex justify-center items-center group"
                  >
                    Add to Enrolment
              ...
              <div className="w-full md:w-1/2 flex-1 md:flex-none bg-slate-50/50 md:bg-slate-50 pt-2 px-3 pb-7 md:p-12 flex flex-col overflow-hidden min-h-[250px]">
                <div className="flex items-center justify-between mb-1 md:mb-8">
                  <div className="flex items-center space-x-2 md:space-x-3">
                    ...
                    <h2 className="text-sm md:text-2xl font-display font-bold text-slate-900">Enrolment Cart</h2>
                  </div>
                  <span className="bg-slate-100 md:bg-slate-200 text-slate-500 md:text-slate-700 px-1.5 md:px-3 py-0.5 md:py-1 text-[9px] md:text-[10px] font-mono md:font-sans font-bold rounded-full border border-slate-200 md:border-0">
                    {cart.length} ITEMS
                  </span>
                </div>
                    ...
                    <div className="space-y-3 md:space-y-4">
                      {cart.map((item) => (
                        <motion.div
                          ...
                          exit={{ opacity: 0, x: -20 }}
                          key={item.id}
                          className="bg-white p-2 md:p-4 border border-slate-100 md:border-slate-200 flex justify-between items-center group shadow-sm md:shadow-none"
                        >
                          <div>
                            <p className="text-[9px] md:text-[10px] font-mono font-bold text-indigo-600 uppercase tracking-tighter mb-0.5">
                              {item.subject}
                            </p>
